...
static const char col_gray1[]       = "#1f1e1c";
static const char col_gray2[]       = "#1f1e1c";
static const char col_gray3[]       = "#fffce6";
static const char col_gray4[]       = "#1f1e1c";
static const char col_cyan[]        = "#fffce6";
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_b,      spawn,          {.v = brwscmd } },
	{ MODKEY,                       XK_d,      spawn,          {.v = disccmd } },
	{ MODKEY,                       XK_s,      spawn,          {.v = spotcmd } },
	//{ MODKEY|ShiftMask,             XK_s,      spawn,          {.v = scr3cmd } },
	//{ MODKEY|ControlMask,           XK_s,      spawn,          {.v = scr2cmd } },
	//{ MODKEY|ShiftMask|ControlMask, XK_s,      spawn,          {.v = scr1cmd } },
